...
CLI:
    python -m workpulse.core.backfill              # full run
    python -m workpulse.core.backfill --dry-run    # report only, no writes
    python -m workpulse.core.backfill --since YYYY-MM-DD
"""
...
from workpulse.common import ROOT, load_config, resolve
