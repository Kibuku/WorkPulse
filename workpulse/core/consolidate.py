...
CLI:
    python -m workpulse.core.consolidate                  # run for today
    python -m workpulse.core.consolidate --date 2026-06-09
    python -m workpulse.core.consolidate --no-llm         # force fallback
    python -m workpulse.core.consolidate --dry-run        # findings only, no file
    python -m workpulse.core.consolidate --json           # findings + result as JSON
"""
...
from workpulse.core import atoms, capture, db, think
from workpulse.common import ROOT, ensure_dir, load_config, resolve, PKG


_SKILL_PATH = PKG / "skills" / "consolidate.md"
