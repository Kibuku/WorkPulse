...
CLI:
    python -m workpulse.core.db init       # create DB, apply all migrations
    python -m workpulse.core.db status     # show current schema version + counts
    python -m workpulse.core.db migrate    # apply any pending migrations
"""
