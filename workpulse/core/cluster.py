...
CLI:
    python -m workpulse.core.cluster refresh                 # full re-cluster
    python -m workpulse.core.cluster status                  # counts + sample
    python -m workpulse.core.cluster params                  # dump live params
"""
...
_SKILL_PATH = PKG / "skills" / "cluster.md"
