...
CLI:
    python -m scripts.think "what's the state of Uganda?"
    python -m scripts.think "..." --stream dev --limit 15 --vector
    python -m scripts.think "..." --no-llm    # force fallback
    python -m scripts.think "..." --json      # emit the result dict
"""
...
from scripts import atoms, db, search
from scripts.common import ROOT, load_config


_SKILL_PATH = ROOT / "skills" / "think.md"
