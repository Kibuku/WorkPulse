...
CLI:
    python -m scripts.search "query text"
    python -m scripts.search --reindex
    python -m scripts.search "q" --limit 20 --stream dev --since 2026-05-01
    python -m scripts.search "q" --vector   # requires fastembed (or env override)
