...
CLI:
    python -m scripts.name_clusters                  # name everything pending
    python -m scripts.name_clusters --since 2026-06-01
    python -m scripts.name_clusters --force          # re-name llm entries
    python -m scripts.name_clusters --no-llm         # fallback-only path
"""
...
from scripts import atoms, db, think
from scripts.common import ROOT, load_config


_SKILL_PATH = ROOT / "skills" / "name-cluster.md"
