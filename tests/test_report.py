...
from scripts import (atoms, capture as capmod, cluster, consolidate,
                     db, name_clusters as nc, report as rmod, think)
...
def test_email_sends_with_monkeypatched_smtp(env, monkeypatch):
    ...
    monkeypatch.setitem(sys.modules, "scripts.wp_secrets", fake_secrets)
